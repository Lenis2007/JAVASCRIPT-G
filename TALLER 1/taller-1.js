...
function any() {
    let cualquierDato = 1011098899;
    console.log("Variables any | ", cualquierDato);
}
any();
// Dos variables string (cadena de texto):
function string() {
    let cadenaTexto = "Analisis y Desarrollo de Software";
...
let semana = { lunes: "Lunes", martes: "Martes", miercoles: "Miercoles", jueves: "Jueves", viernes: "Viernes", sabado: "Sabado", domingo: "Domingo" };
// Una variable tipo objeto cuyos valores sean los números del 0 al 9
let números = { cero: 0, uno: 1, dos: 2, tres: 3, cuatro: 4, cinco: 5, seis: 6, siete: 7, ocho: 8, nueve: 9 };
...
function eliminarCV() {
    let cvEliminar = { uno: 1, nombre: "Lenis" };
...
function leerCV() {
    let cvLeer = { uno: 1, nombre: "Holi", saludo: "Hi" };
...
function actualizarCV() {
    let cvActualizar = { uno: 1, nombre: "Holi", saludo: "Hi" };
